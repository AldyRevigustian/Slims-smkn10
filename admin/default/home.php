...
<div class="contentDesc">
    <div class="container-fluid">
        ...
        ?>
                ...
                <div class="col col-md-4 s-dashboard">
                    <div class="card border-0">
                        <div class="card-body">
                            ...
                            <table class="table">
                                <tr>
                                    <td class="text-left"><i class="fa fa-square" style="color:#f2f2f2;"></i>&nbsp;&nbsp;<?php echo __('Total') ?>
                                    </td>
                                    <td class="text-right loan_total">0</td>
                                </tr>
                                <tr>
                                    <td class="text-left"><i class="fa fa-square" style="color:#337AB7;"></i>&nbsp;&nbsp;<?php echo __('New') ?>
                                    </td>
                                    <td class="text-right loan_new">0</td>
                                </tr>
                                <tr>
                                    <td class="text-left"><i class="fa fa-square" style="color:#06B1CD;"></i>&nbsp;&nbsp;<?php echo __('Return') ?>
                                    </td>
                                    <td class="text-right loan_return">0</td>
                                </tr>
                                <tr>
                                    <td class="text-left"><i class="fa fa-square" style="color:#4AC49B;"></i>&nbsp;&nbsp;<?php echo __('Extends') ?>
                                    </td>
                                    <td class="text-right loan_extend">0</td>
                                </tr>
                                <tr>
                                    <td class="text-left"><i class="fa fa-square" style="color:#F4CC17;"></i>&nbsp;&nbsp;<?php echo __('Overdue') ?>
                                    </td>
            ...
            <div class="row mt-3">
                <div class="col col-md-12 s-dashboard">
                    <div class="card border-0">
                        <div class="card-body">
                            <h5 class="card-title"><?php echo __('Latest Visitor') ?></h5>
                            <canvas id="visitor-chart" height="294"></canvas>
                            <div class="s-dashboard-legend">
                                <i class="fa fa-square" style="color:#F4CC17;"></i> <?php echo __('Member') ?>
                                <i class="fa fa-square" style="color:#459CBD;"></i> <?php echo __('Visitor') ?>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    $(function() {
        ...
        fetch('<?= SWB ?>index.php?p=api/visitor/chart')
            .then(res => res.json())
            .then(res => {
                console.log(
                    res
                ...
                let lineChartData = {
                    labels: Object.values(res[0].xAxis).sort(),
                    datasets: [{
                            'label': 'Visitor',
                            data: Object.entries(res[0].data.visitor).sort((a, b) => {
                                return a[0] - b[0]
                            }).map(x => x[1]),
                            'fillColor': 'rgba(225,220,220,0)',
                            'strokeColor': 'rgba(69, 156, 189, 0.8)',
                            'pointColor': 'rgba(69, 156, 189, 0.8)',
                        },
                        {
                            'label': 'Member',
                            data: Object.entries(res[0].data.member).sort((a, b) => {
                                return a[0] - b[0]
                            }).map(x => x[1]),

                            'fillColor': 'rgba(225,220,220,0)',
                            'strokeColor': 'rgba(244,204,23, 0.8)',
                            'pointColor': 'rgba(244,204,23, 0.8)',
                        }
                    ]
                }

                let f = $('#visitor-chart');
                let container2 = $(f).parent();
                let ft = f.get(0).getContext("2d");
                $(window).resize(respondCanvasDua);

                function respondCanvasDua() {
                    f.attr('width', $(container2).width()); //max width
                    f.attr('height', $(container2).height()); //max height
                    new Chart(ft).Line(
                        lineChartData, {
                            // responsive: true,
