...
require __DIR__ . '/controllers/VisitorController.php';
...
// $router->map('GET', '/visitor/summary', 'VisitorController@getSummary');
$router->map('GET', '/visitor/chart', 'VisitorController@getChart');
